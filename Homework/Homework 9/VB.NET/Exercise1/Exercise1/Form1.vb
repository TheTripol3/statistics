Public Class Form1
    ...
    Private Sub generation()
        ...
        For i As Integer = 1 To m
            ...
            For j As Integer = 1 To n
                Dim number As Double = SurroundingSub(0, 1)
                Dim sumNumber As Double = sigma * Math.Sqrt(1 / n) * number
    ...
    Private Sub DrawSceneGenerate()
        ...
        For Each objectList In listDictN
        ...
        For Each kvp As sizeIntervals In listIntervalsN2
            ...
            Dim height As Single = Me.Y_ViewPort(kvp.lowerPoint * Math.Truncate(ViewPort.Height / 15), ViewPort, MinY_windows, RangeY) - Me.Y_ViewPort(kvp.upperPoint * Math.Truncate(ViewPort.Height / 15), ViewPort, MinY_windows, RangeY)
