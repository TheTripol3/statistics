...
Public Class Form6
            ...
            If obj.Checked Then
                If obj.Text <> Form1.Label4.Text Then
                    ...
                    If index = "System.Int32" OrElse
                        ...
                        Else
                            Me.RichTextBox1.Clear()
                            Me.RichTextBox1.AppendText("Error (Type): The data is of a different types")
                        End If
    ...
    Private Sub Form6Closing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        Form7.Close()
    End Sub
End Class